...
controller.retrieveAll = async (req, res) => {
  try {
    ...
    const result = await Medico.find()
...
controller.retrieveOne = async(req, res) => {
  try {
    const result = await Medico.findById(req.params.id)
...
controller.update = async (req, res) => {
  try {
    ...
    const result = await Medico.findByIdAndUpdate(req.params.id, req.body)
...
controller.delete = async (req, res) => {
  try {
    const result = await Medico.findByIdAndDelete(req.params.id)
