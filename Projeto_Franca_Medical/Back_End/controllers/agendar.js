...
controller.retrieveAll = async (req, res) => {
  try {
    ...
    const result = await Agendar.find()
...
controller.retrieveOne = async(req, res) => {
  try {
    const result = await Agendar.findById(req.params.id)
...
controller.update = async (req, res) => {
  try {
    ...
    const result = await Agendar.findByIdAndUpdate(req.params.id, req.body)
...
controller.delete = async (req, res) => {
  try {
    const result = await Agendar.findByIdAndDelete(req.params.id)
