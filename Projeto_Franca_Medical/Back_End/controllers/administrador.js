...
controller.retrieveOne = async(req, res) => {
  try {
    const result = await Administrador.findById(req.params.id)
...
controller.update = async (req, res) => {
  try {
    ...
    const result = await Administrador.findByIdAndUpdate(req.params.id, req.body)
...
controller.delete = async (req, res) => {
  try {
    const result = await Administrador.findByIdAndDelete(req.params.id)
